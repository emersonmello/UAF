...
public class FidoUafResource {
     ...
     * application is implemented on various platforms. For example, the
     * application MyBank may have an Android app, an iOS app, and a Web app.
...
//		return "https://www.head2toes.org/fidouaf/v1/public/uaf/facets";
    ...
    public String deregRequestPublic(String payload) {
        String res = new DeregRequestProcessor().process(payload);
        System.out.println("Dereg result...: " + res);
        return res;
    }
